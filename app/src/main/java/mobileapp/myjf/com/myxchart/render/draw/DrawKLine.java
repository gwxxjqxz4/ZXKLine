...
public class DrawKLine {
    ...
    public static void drawKLine(Activity activity, KLineLocal kLineLocal) {
        ...
        kLineLayout.setOnTouchListener(new KLineOnTouchListener(activity, kLineRender, kLineLocal));
