package mobileapp.zixiao.com.zxchart.ui.onclicklistener;
...
public class SecondaryClickListener implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (mobileapp.zixiao.com.zxchart.R.id.rl_macd == v.getId()) {
            setTab(0);
        }
        if (mobileapp.zixiao.com.zxchart.R.id.rl_rsi == v.getId()) {
            setTab(1);
        }
        if (mobileapp.zixiao.com.zxchart.R.id.rl_bias == v.getId()) {
            setTab(2);
        }
        if (mobileapp.zixiao.com.zxchart.R.id.rl_kdj == v.getId()) {
            setTab(3);
        }
    }
